export default _xyz => entry => {
    ...
    let span = mapp.utils.html.node`
      <span
        style="display: none; font-size: smaller; color: red;">${mapp.dictionary.location_json_edit_msg}`;

    let content = JSON.stringify(entry.value, null, 2);

    let inner_div = entry.edit ? mapp.utils.html.node`<pre><code><textarea 
    ...
    }}>${content}` : mapp.utils.html.node`<pre><code>${content}`;
