...
export default _xyz => {
  ...
  function create(location) {
    ...
    // Expander icon.
    location.infoj && header.appendChild(mapp.utils.html.node `
      <button
    ...
    // Edit geometry icon.
    location.layer.edit && location.layer.edit.geometry && header.appendChild(mapp.utils.html.node `
      <button
        style = "${'filter: ' + location.colorFilter + '; -webkit-filter: ' + location.colorFilter}"
    ...
    // Trash icon.
    location.layer.edit && location.layer.edit.delete && header.appendChild(mapp.utils.html.node `
      <button
        style = "${'filter: ' + location.colorFilter + '; -webkit-filter: ' + location.colorFilter}"
