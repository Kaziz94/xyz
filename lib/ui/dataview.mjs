export default _xyz => {
  ...
  function create(dataview) {
    ...
    dataview.dataview = dataview.target instanceof HTMLElement && dataview.target
      || mapp.utils.html.node`<div class="${`${dataview.class || ''}`}" style="${dataview.style || ''}">`
    ...
    dataview.target = dataview.dataview.appendChild(mapp.utils.html.node`
      <div class="target">`)
  ...
  function toolbar(dataview) {
    ...
    dataview.toolbar.node = dataview.dataview.appendChild(mapp.utils.html.node`
      <div class="toolbar">`)

    dataview.toolbar.viewport
      && dataview.toolbar.node.appendChild(mapp.utils.html.node`
        <button
  ...
  function chart(dataview) {
    ...
    const canvas = dataview.target.appendChild(mapp.utils.html.node`<canvas>`)
    ...
    dataview.setData = data => {
      ...
      if (!data) {
        ...
        dataview.target.innerHTML = `<div style="text-align:center;"><small>${mapp.dictionary.dataview_no_data}</small></div>`
        return;
      }
  ...
  function table(dataview) {
    ...
    dataview.target = dataview.target.appendChild(mapp.utils.html.node`<div>`);
