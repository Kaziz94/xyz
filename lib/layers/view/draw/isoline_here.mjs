export default _xyz => layer => {
    ...
    function createElements(group) {
        ...
        let date_picker_label = mapp.utils.html.node `<span>${_xyz.language.here_depart}`
        ...
        let dateSelect = mapp.utils.html.node `<input type="text" placeholder=${_xyz.language.layer_filter_pick} style="text-align: end;">`;
