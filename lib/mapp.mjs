...
import create from './mapview/_create.mjs'
...
function _xyz(params = {}) {
  ...
  mapp.dictionary = Object.assign(
    {},
    dictionaries.en,
    mapp.hooks?.current?.language && dictionaries[mapp.hooks.current.language]
