export default (_xyz) => {
  ...
  function settings(entry) {
    ...
    if (entry.edit.isoline_tomtom && !entry.edit.isoline_tomtom.geometry && (entry.edit.isoline_tomtom.timeBudgetInSec || !entry.edit.isoline_tomtom.timeBudgetInSec && entry.value))
      return;
    if (entry.edit.isoline_tomtom && entry.edit.isoline_tomtom.geometry && entry.edit.isoline_tomtom.timeBudgetInSec && !entry.value)
      return;
    panel(entry);
    if (entry.edit.isoline_tomtom && entry.edit.isoline_tomtom.geometry && (entry.edit.isoline_tomtom.timeBudgetInSec || !entry.edit.isoline_tomtom.timeBudgetInSec && entry.value)) {
      edit(entry);
  ...
  function createElements(entry) {
    if (entry.edit.defaults.departAt === void 0) {
      let departAt = mapp.utils.html.node`<input type="text" placeholder=${mapp.dictionary.layer_filter_pick} style="text-align: end;">`;
    ...
    if (entry.edit.defaults.timeBudgetInSec === void 0) {
      entry.edit.panel.appendChild(mapp.utils.html.node`
        	<div style="margin-top: 12px; grid-column: 1 / 3;">
    ...
    if (entry.edit.defaults.traffic === void 0)
      entry.edit.panel.appendChild(mapp.utils.html.node`
    ...
    if (entry.edit.defaults.travelMode === void 0)
    ...
    if (entry.edit.defaults.routeType === void 0)
      entry.edit.panel.appendChild(makeDropdown({
        title: "Route type",
        options: routeTypes,
        callback: (e) => {
    ...
    if (entry.edit.defaults.vehicleMaxSpeed === void 0)
      entry.edit.panel.appendChild(mapp.utils.html.node`
        <div style="padding-top: 5px; grid-column: 1 / 3">
  ...
  function create(entry) {
    if (!entry.edit.isoline_tomtom.timeBudgetInSec)
      entry.edit.isoline_tomtom.timeBudgetInSec = 60 * 10;
    if (!entry.edit.isoline_tomtom.routeType)
      entry.edit.isoline_tomtom.routeType = "fastest";
    if (!entry.edit.isoline_tomtom.travelMode)
      entry.edit.isoline_tomtom.travelMode = "car";
    const ll = ol.proj.toLonLat(entry.location.geometry.coordinates, `EPSG:${entry.location.layer.srid}`);
    _xyz.proxy(`https://api.tomtom.com/routing/1/calculateReachableRange/${ll[1]},${ll[0]}/json?${mapp.utils.paramString(entry.edit.isoline_tomtom)}&key={TOMTOM}`).then((response) => {
  ...
  function update(entry) {
    ...
    entry.newValue = JSON.parse(geoJSON.writeFeature(features[0], {
